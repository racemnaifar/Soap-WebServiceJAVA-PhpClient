            ...
            <div class="card-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php
				 ...
				 $result = $mathservice->getListPersonByName(array("nom"=>"".$_REQUEST['namep'].""));
				 for($numero = 0; $numero < count($result->return); $numero++){
				 ?>
                <tr>
				  <td><?php echo $result->return->id ?></td>
                  <td><?php echo $result->return->name?></td>
                  <td><?php echo $result->return->adress ?></td>
                  <td><?php echo $result->return->birthYear?></td>
